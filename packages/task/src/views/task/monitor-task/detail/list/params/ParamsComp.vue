...
<template>
  <div class="query-comp">
    ...
    <org-cascader v-else-if="config.type === 'FormOrg'" v-model="query" :max-collapse-tags="1" check-strictly filterable multiple ollapse-tags style="width: 177px;" @change="handleSearch" />
