...
<template>
  <div class="query-comp">
    ...
    <organization v-else-if="config.type === 'organization'" v-model="query[config.item]" :placeholder="`请选择${config.name}`" :max-collapse-tags="1" check-strictly multiple ollapse-tags style="width: 177px;" />
